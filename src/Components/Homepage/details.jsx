        ...
        <div className='pt-10 pb-20 px-3 md:px-5 lg:px-0'>
            ...
            <ul className='max-w-5xl mx-auto'>
                <li className='flex flex-col md:flex-row items-center gap-8 bg-gray-100 rounded'>
                    ...
                    <p className='text-xl md:pr-5 p-3 md:p-3 pb-5 md:pb-0'> We seek to invest in startups addressing local problems head on, beyond the MVP
                ...
                <li className='flex flex-col md:flex-row items-center gap-8 bg-gray-100 rounded mt-10'>
                    ...
                    <p className='text-xl md:pr-5 p-3 md:p-3 pb-5 md:pb-0'>The macro and micro matter. As such, we seek to invest in startups that can identify
