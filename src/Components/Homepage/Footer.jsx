...
export default function Footer() {
    return (
        <div className="bg-[#0096c7] text-white pt-8 pb-5">
            <div className="max-w-5xl md:px-3 lg:px-0 mx-auto">
                <ul className='flex flex-col md:flex-row justify-between items-center md:items-start gap-2'>
                    <li className='font-semibold'><a href="#home">Home</a></li>
                    <li className='font-semibold'><a href="#about">About</a></li>
                    <li className='font-semibold'><a href="#portfolio">Companies</a></li>
                </ul>
